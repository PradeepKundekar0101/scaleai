...
const showcaseCards = [
  {
    ...
    desc: "AI agents that understand your codebase deeply",
  },
  {
    image: "/img2.jpg",
    title: "Build with Confidence",
    desc: "Security-first approach to API exposure",
  },
  {
    image: "/img3.jpg",
    title: "Open New Doors",
    desc: "Turn your internal APIs into revenue streams",
  },
  {
    image: "/img4.jpg",
    title: "Scale Without Limits",
    desc: "From startup to enterprise, built for growth",
  },
];
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-28 overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-[#1b1938]/75" />
          <div className="absolute inset-0 bg-gradient-to-b from-[#1b1938]/40 via-transparent to-[#1b1938]/60" />
        </div>
        <div className="relative max-w-4xl mx-auto px-6 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/15 backdrop-blur-sm px-4 py-1.5 rounded-lg mb-8">
          ...
          <div className="flex items-center justify-center gap-4">
            <Link
              ...
              className="inline-flex items-center gap-2 bg-white text-[#1b1938] px-7 py-3 rounded-lg text-base font-semibold hover:bg-white/90 transition-colors"
            >
            ...
            <Link
              to="/docs/quickbite"
              className="inline-flex items-center gap-2 text-white/90 border border-white/25 backdrop-blur-sm px-7 py-3 rounded-lg text-base font-medium hover:bg-white/10 transition-colors"
            >
              See Demo Docs
            </Link>
          </div>
      ...
      {/* Transition gradient */}
      <div className="h-16 bg-gradient-to-b from-[#0d0b1e] to-white" />
        ...
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {showcaseCards.map((card) => (
              <div
                key={card.title}
                className="group relative rounded-2xl overflow-hidden h-[280px] cursor-default"
              >
                <img
                  src={card.image}
                  alt={card.title}
      ...
      <footer className="border-t border-[#dcd7d3] py-10 px-6">
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <img src="/logo-small.png" alt="Scalable" className="w-6 h-6 object-contain" />
